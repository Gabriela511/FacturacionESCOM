...
CREATE TABLE `cliente` (
  ...
  `RFC` varchar(14) COLLATE utf8_spanish_ci DEFAULT NULL, 
  /*`direccion` varchar(150) COLLATE utf8_spanish_ci DEFAULT NULL,*/
  `calle` varchar(30) COLLATE utf8_spanish_ci NOT NULL, 
  `nexterior` varchar(4) COLLATE utf8_spanish_ci NOT NULL, 
  `ninterior` varchar(4) COLLATE utf8_spanish_ci DEFAULT NULL, 
  `colonia` varchar(30) COLLATE utf8_spanish_ci NOT NULL, 
  `mun_del` varchar(40) COLLATE utf8_spanish_ci NOT NULL, 
...
ALTER TABLE `codDetalle` AUTO_INCREMENT = 0;
...
ALTER TABLE `codFactura` AUTO_INCREMENT = 0;
...
ALTER TABLE `codProducto` AUTO_INCREMENT = 0;
...
ALTER TABLE `codUsuario` AUTO_INCREMENT = 0;
...
CREATE TABLE `vendedor` (
  ...
  `estado` varchar(40) COLLATE utf8_spanish_ci NOT NULL, 
  `CP` int(5)  NOT NULL, 
  `claveElector` varchar(18) COLLATE utf8_spanish_ci NOT NULL,
  `email` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`codVendedor`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
ALTER TABLE `codVendedor` AUTO_INCREMENT = 0;
